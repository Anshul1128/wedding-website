$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Anshul and Aashita's Wedding",

            // Event start date
            start: new Date('Jan 18, 2025 9:00'),
            ...
            end: new Date('Jan 19, 2025 00:00'),

            // Event Address
            address: 'Krishnakunj Parisar, Khargone',
...
function initMap() {
    ...
    var t = new google.maps.Map(document.getElementById("map-canvas"), {
      zoom: 15,
      center: e,
      scrollwheel: false
    });
  
    // Correct way to create a marker:
